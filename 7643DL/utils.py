...
def plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history):
    ...
    ax1.plot(valid_loss_history,label="Validation")
    ax1.legend()
    ax1.set_title('Loss Curve')
    f1.savefig("Loss Curve.png")

    ax2 = f2.add_subplot(111)
    ax2.plot(train_acc_history,label="Train")
    ax2.plot(valid_acc_history,label="Validation")
    ax2.set_title('Accuracy Curve')
    ax2.legend()
    f2.savefig("Accuracy Curve.png")

    # fig, axs = plt.subplots(2)
    #
    # axs[0].plot(train_loss_history)
    # axs[0].plot(valid_loss_history)
    # axs[0].set_title('Loss')
    #
    # axs[1].plot(train_acc_history, label="Train")
    # axs[1].plot(valid_acc_history, label="Validation")
